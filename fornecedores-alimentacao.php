...
<body>
    ...
    <?php
        include ('public/popupModal-food.php');
    ...
    <div class="suppliersPage-body mw-1440">
        <h3 class="mw-1440">Restaurantes encontrados: </h3>
    ...
    <script>
        ...
        const filterCardTitles = ['Restaurantes', 'Lanchonetes', 'Sushis', 'Pizzarias', 'Gourmet', 'Padarias', 'Vegano'];
        const filterCardIcons = ['mdi-silverware-variant', 'mdi-food', 'mdi-fish', 'mdi-pizza', 'mdi-hamburger', 'mdi-bread-slice-outline', 'mdi-leaf']
