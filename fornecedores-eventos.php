...
<body>
    ...
    <div class="suppliersPage-body mw-1440">
        <h3 class="mw-1440">Eventos encontrados: </h3>
        ...
        <h3 class="pb-2 mb-3 border-bottom mw-1440">Tipo de Evento 1: </h3>
        <div class="swiper-container mb-4 full-carousel-cards">
            <div class="swiper-wrapper">
                <?php    
                    for($i = 0; $i < 9; $i++){
        ...
        <h3 class="pb-2 mb-3 border-bottom mw-1440">Tipo de Evento 2: </h3>
        <div class="swiper-container mb-4 full-carousel-cards">
            <div class="swiper-wrapper">
                <?php    
                    for($i = 0; $i < 9; $i++){
