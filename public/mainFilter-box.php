    ...
    <div class="mainFilter-container ">
        <div class="mainFilter-title">
            ...
            <div class="mainFilter-tabs ">
                ...
                <ul>
                    <li class="mainFilter-tab active"><span class="mdi mdi-office-building-outline "></span>Hospedagem</li>
                    <li class="mainFilter-tab "><span class="mdi mdi-silverware-fork-knife "></span>Alimentação</li>
