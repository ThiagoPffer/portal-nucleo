        ...
        <div class="mainFilter-container">
            <div class="mainFilter-box">
                <form class="mainFilter-box-form" action="#">
                    ...
                    <div class="form-group">
                        <label for="select4">Nº de pessoas</label>
                        <select name="hospedes" class="form-control">
                    ...
                    <button class="mainFilter-search-btn" type="submit"><span class="mdi mdi-magnify"></span></button>
                </form>
            </div>
        </div>
